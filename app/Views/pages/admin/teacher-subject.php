...
<div class="pd-ltr-20 xs-pd-20-10">
  <div class="min-height-200px">
    ...
    <div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
      <button class="btn btn-primary btn-sm mb-3" id="add_btn"><i class="bi bi-plus-lg"></i> ADD TEACHER
        SUBJECT</button>
...
$(document).ready(function() {
  ...
  $('#add_teacher, #add_grade, #add_subject, #edit_teacher, #edit_grade, #edit_subject, #filter_grade, #filter_subject')
    .select2();
  ...
  dataTable = $('#table').DataTable({
    ...
    sScrollXInner: "100%",
    ajax: {
      url: "<?= route_to('admin.teacher-subject-data') ?>",
      type: "POST",
      data: function(d) {
        return $.extend({}, d, {
  ...
  $('#add_grade').on('change', (e) => {
    ...
    populateRoomDropdown(id, $('#add_subject'));
  })
